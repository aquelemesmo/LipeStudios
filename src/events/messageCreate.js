...
module.exports = async (bot, message) => {
    if(message.content === `<@!${bot.user.id}>` || message.content === `<@${bot.user.id}>`) {
        ...
        .addField("> E caso queira me votar no top.gg, digite ``lp!vote``", "©・Todos os direitos reservados de LipeStudios 2021")
    ...
    if(arquivoCommand) {
        ...
        bot.channels.cache.get("792960925694033940").send({embeds: [executeCommandEmbed]})
    }
