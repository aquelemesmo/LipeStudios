...
module.exports.run = async (bot,message,args) => {
    if(!message.member.permissions.has("KICK_MEMBERS")) return message.reply(mensagem.sem_permissao)
    if(!message.guild.me.permissions.has("KICK_MEMBERS")) return message.reply(mensagem.sem_permissao_bot)
