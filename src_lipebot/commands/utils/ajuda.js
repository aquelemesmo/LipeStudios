...
module.exports.run = async (bot, message, args) => {
    ...
    if(args[0] === "premium") {
        const embedPremium = new MessageEmbed()
        .setColor("PURPLE")
        .setTitle("Meu painel de controle PREMIUM")
        .setThumbnail(bot.user.displayAvatarURL())
        .setDescription("Você está na versão PREMIUM dos meus sistemas! caso queira ver os comandos da minha versão atual, digite ``lp!ajuda``")
        .addFields(
